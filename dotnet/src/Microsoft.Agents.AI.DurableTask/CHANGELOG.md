...
- Updated Agent Framework dependencies to 1.22.0 and preserved the orchestration synchronization context for durable agent invocations ([#116](https://github.com/microsoft/agent-framework-durable-extension/pull/116))
