...
- Surface durable mailbox terminal failures and unavailable results without successful fallback responses, preserve completion outcome metadata, and add opt-in full-result MCP responses while retaining legacy text output ([#94](https://github.com/microsoft/agent-framework-durable-extension/pull/94))
