...
- Updated Agent Framework dependencies to 1.22.0, including the compatible OpenAI dependencies used by the samples ([#116](https://github.com/microsoft/agent-framework-durable-extension/pull/116))
