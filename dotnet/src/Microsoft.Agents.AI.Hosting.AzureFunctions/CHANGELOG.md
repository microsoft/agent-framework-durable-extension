...
- Prefer camelCase names on agent HTTP requests and responses (`sessionId`, `waitForResponse`) while continuing to accept legacy snake_case request names during the migration window ([#103](https://github.com/microsoft/agent-framework-durable-extension/pull/103))
