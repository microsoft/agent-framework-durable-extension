...
.EXAMPLE
    ...
    ./dotnet/eng/scripts/New-FilteredSolution.ps1 -Solution dotnet/agent-framework-durable-extension.slnx -TargetFramework net10.0 -TestProjectNameIncludeFilter "*UnitTests*" -OutputPath filtered-unit.slnx
