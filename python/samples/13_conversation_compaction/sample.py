...
"""Conversation Compaction Sample - Durable Task Integration (Combined Worker + Client)

Runs both the worker and client in a single process. The worker is started first to
