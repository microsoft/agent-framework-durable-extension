...
with Azure CLI before starting the Functions host. Select a fresh, unique task hub and
acknowledge isolation with `DURABLE_AGENTS_DEPLOYMENT_MODE=isolated_v2`. Leaving this
acknowledgement unset or blank intentionally fails host initialization."""
