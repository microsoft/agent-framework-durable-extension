...
def test_sparse_legacy_payloads_preserve_omission_but_reject_foreign_types(payload: dict[str, Any]) -> None:
    before = deepcopy(payload)
    if "type" in payload and payload["type"] != "agent_response":
...
def test_present_response_type_must_match_the_fixed_base_type(response_type: Any) -> None:
